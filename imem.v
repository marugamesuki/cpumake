...
module imem(input [`PCS:0] pc, output logic [`CMDS:0] o);
	always_comb
		...
		6'h03: o = 16'b1000_01_10_0000_0001;//LIL r1 <- 1
		6'h04: o = 16'b1000_01_11_0000_0000;//LIH r1 <- 1

		////カウンタの初期値
		6'h05: o = 16'b1000_11_10_0001_0000;//LIL r3 <- 16
		6'h06: o = 16'b1000_11_11_0000_0000;//LIH r3 <- 16
		
		////計算
		6'h07: o = 16'b0000_10_10_0000_0001;//r2<-a+b
		6'h08: o = 16'b0000_10_00_0010_0001;//r0<-r1
		6'h09: o = 16'b0000_10_01_0010_0010;//r1<-r2

		////カウンタの更新
		// 0 0 1 # rw> a-> im------------> ; CAL rw=ra,im (#=0:ADD/1:SUB only)
		6'h0a: o = 16'b0011_11_11_0000_0001;

		////ジャンプ
		// 0 1 0 p 1 1 f f im------------> ; JP/BR fp [PC + (s)im]
		6'h0b: o = 16'b0100_11_01_1111_1100;//補数表現-4
